...
adb exec-out run-as com.example.frontend cat databases/tasks.db > "C:\Users\Amir\Desktop\Studygded\Degree Year 3\Semester 2\Mobile Application Development\TaskFlow\frontend\lib\auth.db"
